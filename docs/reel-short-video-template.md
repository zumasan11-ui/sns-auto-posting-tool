...
- Facebook個人手動投稿用: 同じ動画を `deliverables/facebook_manual/latest_facebook_personal_reel.mp4` に保存し、コピペ用キャプションを `deliverables/facebook_manual/latest_facebook_personal_caption.txt` に保存する
