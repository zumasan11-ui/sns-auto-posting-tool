...
- 自動投稿で増える `deliverables/auto_post/`、`public_state/public/runs/`、`public_state/public/manual_tests/`、`deliverables/facebook_manual/` のファイルは7日より古いものを自動削除する。Facebook個人用の `latest_*.mp4` / `latest_*.txt` も例外なく7日で削除する
